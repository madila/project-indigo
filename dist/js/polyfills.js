(function() {
    ...
    (typeof CustomEvent === 'function') || loadScript(window.indigo.js_dist_url+'/custom-event.js');
    ...
    ('registerElement' in document && 'import' in document.createElement('link') && 'createShadowRoot' in HTMLElement.prototype && 'content' in document.createElement('template')) || loadScript(window.indigo.js_dist_url+'/lite.js');
}());