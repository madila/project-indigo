(function() {
    ...
    ('import' in document.createElement('link') || 'createShadowRoot' in HTMLElement.prototype || 'content' in document.createElement('template')) || loadScript(window.indigo.vendor_url+'webcomponents-lite.js');
}());